...
db.collection('tips').where('lab','==','1').get().then((snapshot) => {
    let html = '';
    const lab = `
    <a class="waves-effect waves-light btn grey darken-2"><i class="material-icons left">collections_bookmark</i>Lab01 Tips</a>
    <br></br>
    `; 
    html += lab;    
